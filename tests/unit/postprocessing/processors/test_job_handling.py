...
def test_local_submission(mocker, configuration, script, input_file, output_dir, out_log, out_err):
    pass
...
@pytest.mark.parametrize(
        ...
        [
            ...
            (['exception'],     b"Error: regex found, exception handled",   True,   {"information": "regex found, exception handled"})
        ]
    )
