...
# package imports
from postprocessing.Configuration import Configuration, initialize_logging, read_configuration, StreamToLogger
...
def test_read_configuration(data_server):
    ...
    backup = sys.stderr
    try:
        conf = read_configuration(config_file=data_server.path_to('post_processing.conf'))
