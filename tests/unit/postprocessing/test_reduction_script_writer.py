...
@pytest.yield_fixture(scope='module')  # 'yield_fixture' deprecated in favor of 'yield' when using python 3.x
def writer_local(data_server):
    ...
    shutil.copyfile(data_server.path_to(writer.template_name),
...
class TestScriptWriter(object):
    arguments = {'mask': """MaskBTPParameters.append({'Pixel': '121-128'})
    ...
    """,
                 ...
                 'grouping': '8x2',
                 'e_min': '-0.95', 'e_max': '0.95', 'e_step': '0.005',
                 'e_pars_in_mev': False,
                 'tib_min': '', 'tib_max': '',
                 'do_tib': True,
                 't0': '',
                 ...
                 'create_md_nxs': False,
                 'a': '8.355', 'b': '8.355', 'c': '9.076',
                 'alpha': '90.0', 'beta': '90.0', 'gamma': '120.0',
                 'u_vector': '-1.46299,-1.46299,8.50124', 'v_vector': '3.91295,3.91295,3.17848',
                 'sub_directory': '/tmp',
    ...
    def test_get_arguments(self, writer_local):
        ...
        assert keywords == {'do_tib', 'processed_vanadium', 'e_step', 'tib_max', 'tib_min', 'u_vector',
                            'temperature_names', 'sub_directory', 'create_elastic_nxspe', 'e_pars_in_mev',
                            'create_md_nxs', 'beta', 'v_vector', 'vanadium_integration_min', 'auto_tzero_flag',
                            'alpha', 'vanadium_integration_max', 'a', 'motor_names', 'c', 'b', 'mask', 't0', 'e_min',
                            'raw_vanadium', 'grouping', 'gamma', 'e_max'}
    ...
    def test_write_script(self, data_server, writer_local):
        ...
        filecmp.cmp(script_new,
                    data_server.path_to(writer_local.script_name),  # expected script
                    shallow=False)  # compare contents, not just metadata
    ...
    def test_process_request(self, data_server, writer_local):
        ...
        shutil.copyfile(data_server.path_to(writer_local.template_name),
